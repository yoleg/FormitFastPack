...
&case1=`text` &then1=`
  <input type="[[+type]]" name="[[+name]]" id="[[+name]]" value="[[!+[[+prefix]][[+name]]]]" class="[[+class]][[!+[[+prefix]]error.[[+name]]:notempty=` error`]]" size="40">
`
&case2=`textarea` &then2=`
  <textarea id="[[+name]]" class="[[+type]] [[+class]][[!+[[+prefix]]error.[[+name]]:notempty=` error`]]" name="[[+name]]">[[!+[[+prefix]][[+name]]]]</textarea>
`
...
`
&case6=`select` &then6=`
<select name="[[+name]]" id="[[+name]]" class="[[!+[[+prefix]]error.[[+name]]:notempty=`error`]]">
...
[[!+[[+prefix]]error.[[+name]]:notempty=`<span class="error">[[!+[[+prefix]]error.[[+name]]]]</span>`]] 
</p>
</div>